...
To use patchwork to combine our disparate plots, first we'll store our histogram and time-series plots as objects in R. We'll call them 'a' and 'b'. While we do that, since we're interested in creating publication quality figures, we'll make the x an y-axis labels more meaningful and add ggplot's 'theme_classic' to get the plots looking sleek. 
