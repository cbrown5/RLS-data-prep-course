...
## Why R and RStudio for data analysis?
...
Nice features of rstudio - script, console, environment, files plots, help, etc.

Few basics (maybe too basic for this course?)
Functions, arguments, asking for help, e.g. ?function
...
Folders 'talk' to each other - pathfile names
Always keep raw data - modify/wrangle in script

## New script

Name it, date it etc... 
Naming convention r scripts - i.e. Jenny Bryan's awesome file names
Different script for each data exploration/analysis 'chunk'
E.g. 'wrangle-script.R', 'plot.R', 'model.R',....
